...
const BudgetEdit = () => {
    return (
        <>
            ...
            {/*</div>*/}
            <form  className="form-body" style={{width: '400px'}}>
                ...
                <MDBRow >
                    ...
                    <Select style={{marginLeft:'10px'}} name='category_type' className="form-select" aria-label="Default select example" value="">
