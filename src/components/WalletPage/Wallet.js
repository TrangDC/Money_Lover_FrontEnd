                                    ...
                                    <MDBRow style={{textAlign: 'center'}}>
                                        ...
                                        <MDBRow className="wallet-infomation">
                                            ...
                                            <MDBCol className="content-wallet" md='10'>
                                                ...
                                                <MDBCardText style={{fontWeight:'600'}}>{selectedWallet.balance} VNĐ</MDBCardText>
                                            </MDBCol>
                                            <hr/>
                                        </MDBRow>
                                        <MDBRow className="wallet-infomation">
                                    ...
                                    <MDBRow style={{textAlign: 'center'}}>
                                        ...
                                        <MDBRow className="wallet-infomation">
                                            ...
                                            <MDBCol className="content-wallet" md='10'>
                                                ...
                                                <MDBCardText style={{fontWeight:'600'}}>{selectedShareWallet.balance} vnđ</MDBCardText>
                                            </MDBCol>
                                            <hr/>
                                        </MDBRow>
                                        <MDBRow className="wallet-infomation">
